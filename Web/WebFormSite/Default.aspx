<%@ Page Title="홈 페이지" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="_Default" %>
...
<asp:Content runat="server" ID="FeaturedContent" ContentPlaceHolderID="FeaturedContent">
    <section class="featured">
        <div class="content-wrapper">
            ...
            <p>
                ASP.NET에 대해 자세히 알아보려면 <a href="http://asp.net" title="ASP.NET Website">http://asp.net</a>을 방문하십시오. 
                이 페이지에는 <mark>비디오, 자습서 및 샘플 등</mark> ASP.NET을 최대한 활용하는 데 도움이 자료가 준비되어  
                있습니다. ASP.NET에 대한 질문이 있는 경우에는 
                <a href="http://forums.asp.net/18.aspx" title="ASP.NET Forum">ASP.NET 포럼</a>을 방문하십시오.
            </p>
        </div>
    </section>
</asp:Content>
